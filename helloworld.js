/*.
1- 
 take a score with prompt and apply it with below explanations
AA 90-100
BA 85-89
BB 80-84
CB 75-79
...
FF 0-49
2- 
chech the input 1 - 100 else print a message
3- with ff degree use an icon and red color and with others use an icon with blue color
4- use for ff degre a class named text-danger and others should have text-primary
*/
